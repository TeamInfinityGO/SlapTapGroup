...
PM_START_TEXT = f"""
*Hellow There, I'm Slap-Tap🍑

I'm a Powerfull group manager bot With Cool Modules.
Specially Added A Logo Creater - API By SlapTap
hit /help to Find my list of available commands 🕹*
"""

buttons = [
    [
        InlineKeyboardButton(text="📌Updates Channel", url="https://t.me/SlapTap"),
        InlineKeyboardButton(text="🖲 Support Group", url="https://t.me/SlapTaps"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➕ Add SlapTap To Your Group ➕", url="t.me/SlapTapbot?startgroup=true"
        ),
    ],
]


ANKIVECTOR_STICKER = " CAACAgUAAxkBAAESjophvvQXcni6WSfmcr8o46kXA22-sgAC4QQAAqSz-FW4B4KY_pdkDSME"
...
Support them  [Fake Raser](t.me/FakeRaser)"""
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by SlapTap.* "
            f"\n\n Join [SlapTap Updates](https://t.me/SlapTap) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [SlapTap Support](https://t.me/SlapTaps).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Is the redisigned version of Vonom-By TeamInfinityGO for the best performance.*"
            f"\n\nBased on [SlapTap](https://t.me/SlapTapBot)."
